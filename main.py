...
INSTAGRAM_CAPTIONS = environ['INSTAGRAM_CAPTIONS']

# IMAGE PROPERTY SETTINGS
MAX_LENGTH = environ['MAX_LENGTH']
FONT_SIZE = environ['FONT_SIZE']
LINE_HEIGHT = environ['LINE_HEIGHT']
MARGIN_LEFT = environ['MARGIN_LEFT']
MARGIN_TOP = environ['MARGIN_TOP']
